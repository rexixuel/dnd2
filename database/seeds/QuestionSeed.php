...
class QuestionSeed extends Seeder
{
    ...
    public function run()
    {
		...
		// // course 1
		// $question = new App\SummaryQuestion;
				
		// $question->create(["question" => "What is organizational culture? How can one develop an effective organizational culture for an R&D lab?", "course_id" => 1]);
		
		// $question->create(["question" => "Differentiate basic research, applied research, and development.", "course_id" => 1]);

		// $question->create(["question" => "Describe each elements of the cycle of technological change.", "course_id" => 1]);

		// $question->create(["question" => "Differentiate the different type of IP.", "course_id" => 1]);

		// $question->create(["question" => "What are the similarities and differences between innovation and entrepreneurship?", "course_id" => 1]);

		// // course 2
		// $question = new App\SummaryQuestion;
		
		// $question->create(["question" => "Discuss the steps in the general research process.", "course_id" => 2]);
		
		// $question->create(["question" => "Discuss and elaborate on any one of the five structural elements of an R and D organization.", "course_id" => 2]);

		// $question->create(["question" => "Explain the distinctions among basic research, applied research, and experimental development in terms of objective and output.", "course_id" => 2]);

		// $question->create(["question" => "Explain the major differences among First-Generation, Second-Generation, and Third-Generation Research Management.", "course_id" => 2]);

		// $question->create(["question" => "Describe the three major forms of research misconduct.", "course_id" => 2]);

		// // course 4
		// $question = new App\SummaryQuestion;
		
		// $question->create(["question" => "What are the marketing challenges in terms of technology, customers, marketing partners and the world?", "course_id" => 4]);
		
		// $question->create(["question" => "What are the strategies to have a successful R&D marketing interaction?", "course_id" => 4]);

		// $question->create(["question" => "In high tech companies, how does appropriate pricing strategy/consideration are determined?", "course_id" => 4]);

		// $question->create(["question" => "How can a high tech company be involved in a social entrepreneurship?", "course_id" => 4]);

		// $question->create(["question" => "Does patenting really benefit a company? When will the company starts to obtain the benefits?" "course_id" => 4]);

		// // course 5
		// $question = new App\SummaryQuestion;
		
		// $question->create(["question" => "Differentiate a Vertical Technology Transfer and a Horizontal Technology Transfer. Give at least two examples for each technology transfer.", "course_id" => 5]);
		
		// $question->create(["question" => "Differentiate a Global Value Chain and a Global Production Network.", "course_id" => 5]);

		// $question->create(["question" => "Differentiate the \“old industrial policy\” and \“new industrial policy\"", "course_id" => 5]);

		// $question->create(["question" => "What is the recommendation of UNIDO in forming a negotiating team? Why?", "course_id" => 5]);

		// $question->create(["question" => "Differentiate Internal Technology Acquisition and External Technology Acquisition. Give at least two examples for each technology acquisition." "course_id" => 5]);

		// // course 6
		// $question = new App\SummaryQuestion;
		
		// $question->create(["question" => "Briefly discuss the three key activities in the strategic management process. Why is it important for managers to recognize the interdependent nature of these activities?", "course_id" => 6]);
		
		// $question->create(["question" => "What are some of the major trends that now require firms to have a greater strategic management perspective and empowerment in the strategic management process throughout the firm?", "course_id" => 6]);

		// $question->create(["question" => "Why must managers be aware of a firm’s external environment?", "course_id" => 6]);

		// $question->create(["question" => "Briefly describe the primary and support activities in a firm’s value chain.", "course_id" => 6]);

		// $question->create(["question" => "How can managers create value by establishing important relationships among the value-chain activities both within their firm and between the firm and its customers and suppliers?" "course_id" => 6]);
    }
}
